 ...
 * @version 1.0
 */
public class CQueue implements Growable<Long>{
	/**
	 ...
	 */
	public long get(){ return start.data; }
	
	@Override
	public Iterator<Long> iterator(){ return new ListIterator(start); }		
	/**
